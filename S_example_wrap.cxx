...
/*-----------------------------------------------
              @(target):= _S_example.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__S_example

#else
#  define SWIG_init    init_S_example

#endif
#define SWIG_name    "_S_example"
...
SWIGINTERN PyObject *_wrap_square(PyObject *self, PyObject *args) {
  ...
  swig_obj[0] = args;
  {
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "square" "', argument " "1"" of type '" "std::vector< double,std::allocator< double > >""'"); 
    }
    arg1 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  result = square(SWIG_STD_MOVE(arg1));
